...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    private static String viewToString(View view) {
        ...
        StringBuilder out = new StringBuilder(AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || r == null)) {
                ...
                out.append(" ");
                out.append(pkgname);
                out.append(UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR);
                out.append(typename);
                out.append("/");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        int index = (requestCode >> 8) & NalUnitUtil.EXTENDED_SAR;
        if (index != 0) {
            index--;
            int activeFragmentsCount = this.mFragments.getActiveFragmentsCount();
            if (activeFragmentsCount == 0 || index < 0 || index >= activeFragmentsCount) {
            ...
            if (frag == null) {
                ...
                frag.onRequestPermissionsResult(requestCode & NalUnitUtil.EXTENDED_SAR, permissions, grantResults);
            }
        }
    }
    ...
    private void requestPermissionsFromFragment(Fragment fragment, String[] permissions, int requestCode) {
        if (requestCode == -1) {
            ...
            ActivityCompat.requestPermissions(this, permissions, ((fragment.mIndex + MSG_REALLY_STOPPED) << 8) + (requestCode & NalUnitUtil.EXTENDED_SAR));
        }
    }
}
